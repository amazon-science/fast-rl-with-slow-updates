...
class Runner(object):
  ...
  def _run_one_episode(self):
    ...
    while True:
      ...
      if (self._environment.game_over or
        ...
        action, loss = self._agent.step(reward, observation)
        total_loss  += loss
  ...
  def _run_one_phase(self, min_steps, statistics, run_mode_str):
    ...
    while step_count < min_steps:
      episode_length, episode_return, loss = self._run_one_episode()
      total_loss = total_loss + loss
      statistics.append({
          '{}_episode_lengths'.format(run_mode_str): episode_length,
          '{}_episode_returns'.format(run_mode_str): episode_return,
          '{}_episode_loss'.format(run_mode_str): loss,
      })
      ...
      sys.stdout.write('Steps executed: {} '.format(step_count) +
                       ...
                       'Episode loss: {} '.format(loss)+
                       'Return: {}\r'.format(episode_return))
      sys.stdout.flush()
    return step_count, sum_returns, num_episodes, total_loss
  ...
  def _run_train_phase(self, statistics):
    ...
    number_steps, sum_returns, num_episodes, loss = self._run_one_phase(
    ...
    return num_episodes, average_return, average_steps_per_second, loss
  ...
  def _run_one_iteration(self, iteration):
    ...
    num_episodes_train, average_reward_train, average_steps_per_second, loss = (
